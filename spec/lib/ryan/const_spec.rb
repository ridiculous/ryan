...
describe Ryan::Const do
  ...
  describe '#func_by_name' do
    it 'returns the functions by name' do
      expect(subject.func_by_name(:verification_code)).to be_a Ryan::InstanceFunc
    end
  ...
  describe '#funcs' do
    it 'returns func objects' do
      expect(subject.funcs.first).to be_a(Ryan::ClassFunc)
      expect(subject.funcs.last).to be_a(Ryan::InstanceFunc)
    end
    ...
    context 'another file' do
      ...
      it 'returns the methods in the file' do
        ...
        expect(subject.funcs.first).to be_kind_of Ryan::InstanceFunc
